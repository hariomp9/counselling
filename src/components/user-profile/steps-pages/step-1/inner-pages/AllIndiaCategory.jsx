        ...
        <>
            ...
            <div className="flex flex-wrap gap-[19px] md:w-[50%]">
                {categoryValues.map((category, index) => (
                    ...
                    ${selectedCategory === category.Select_category ? 'border-1px border-[#D9D9D9] bg-theme_primary' : 'border-1px border-[#D9D9D9] bg-[#FFFFFF] '}
                    `}
                    onClick={() => handleCategoryClick(category)}>
                        <input
                            ...
                            className="hidden"
                        />
                        {selectedCategory === category.Select_category &&  <Image src="/svg/profile/tick_white.svg"  height={16} width={16} alt="select"/>} {/* Tick icon */}
                        <label htmlFor={category._id} className={`text-[15px] font-[400] font-inter leading-[18.15px] whitespace-nowrap
                         ${selectedCategory === category.Select_category ? 'text-[#ffffff]' : 'text-[#747474]'}
                    `}>
