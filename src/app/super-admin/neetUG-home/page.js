...
import neetcard from "../../../../public/images/neetcard.png";
const data = [
  {
    id: 1,
...
const page = () => {
  return (
    <>
      <section>
        <div className="flex justify-around pt-10 xl:pt-14 2xl:pt-20">
          <div className="relative 2xl:w-[1090px] xl:w-[750px] lg:w-[600px] lg:ml-14 xl:ml-20  2xl:ml-44">
            <Image src={neetcard} className="neetCard" />
            ...
            <div className="flex gap-5 2xl:my-10 xl:my-7 lg:my-4">
              <div>
                <Image src={cllgPre} className="neetdata"/>
                <h1 className="neethead">Course Predictor</h1>
              </div>
              <div>
                <Image src={cllgData} className="neetdata" />
                <h1 className="neethead">College Database</h1>
              </div>
              <div>
                <Image src={choice} className="neetdata" />
                  ...
                  {data.map((item) => (
                    <tr key={item.id}>
                      ...
                      <td className=" tablerow flex 2xl:gap-5 gap-3">
                        <Image
                          src={item.image}
                          className="2xl:w-[94px] 2xl:h-[75px] xl:w-[60px] lg:w-[60px] h-auto"
                        />
          ...
          <div className="2xl:w-[604px] xl:w-[450px] lg:w-[300px] ">
              ...
              <div>
                <div className="flex xl:gap-5 gap-3 mt-3 ">
                  <div>
                    <Image
                      src={web1}
                      className="2xl:w-[160px] 2xl:h-[112px] xl:w-[120px] xl:h-auto "
                    />
                  </div>
                  <div>
            ...
            <div className="bg-[#F5F6FF] flex 2xl:gap-10 xl:gap-5 gap-3 2xl:mt-10 mt-7">
              <Image
                src={college}
                className="2xl:w-[227px] 2xl:h-[304px] xl:w-[160px] lg:w-[100px]"
              />
                ...
                <div>
                  ...
                  <div className="mt-7 xl:mt-16 flex justify-between ">
                    <div className="flex gap-1 items-center ">
                      <Image
                        src={users}
                        className="2xl:w-[20px] 2xl:h-[15px] xl:w-[16px] lg:w-[12px]"
                      />
            ...
            <div className="bg-[#F5F6FF]  2xl:mt-10 mt-5 2xl:p-8 p-4 ">
              ...
              <div className="flex 2xl:gap-10 xl:gap-5 gap-3">
                <div className="2xl:w-[245px] xl:w-[180px] lg:w-[120px]">
                  ...
                  <Image src={campus1} className="campusimg" />
                </div>
                <div className="2xl:w-[245px] xl:w-[180px] lg:w-[120px]">
                  <h1 className="neethead3">Passages Lorem Ipsum available</h1>
                  <p className="tablerow ">
                    Lorem Ipsum is simply dummy text of the printing and
                    typesetting industry Lorem Ipsum has been the industry,s
                    standard
                  </p>
                  <Image src={campus2} className="campusimg" />
                </div>
              </div>
            </div>
          </div>
