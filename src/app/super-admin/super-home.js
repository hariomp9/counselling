...
const SuperHome = () => {
  ...
  const [fetchStatics, setFetchStatics] = useState();
  ...
  const handleStatics = async () => {
    ...
    try {
      const response = await axios.get(
        `${config.baseURL}/api/auth/getWeeklyUsers`,
        {
          headers: {
            Accept: "application/json",
            authorization: token,
                        ...
                        <div className="flex">
                          <div>
                            ...
                            <p className="legend font-[500] super_box_noo">
                              {fetchStatics.Free_Subscription_plan}
                            </p>
                          </div>
                        </div>
                      </div>
                      <div className=" bg-white flex items-center 2xl:gap-3 2xl:p-5 2xl:w-[223px] 2xl:h-[93px] xl:w-[140px] xl:h-[55px] w-[95px] xl:p-2 xl:gap-2 h-[40px] gap-2 mt-[25px] rounded-[5px] px-1 ">
                        ...
                        <div className="flex">
                          <div>
                            ...
                            <p className="legend font-[500] super_box_noo">
                              {fetchStatics.One_on_One_Subscription_plan}
                            </p>
                          </div>
                        </div>
                      </div>
