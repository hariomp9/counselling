...
import s10 from "../../../../public/images/s9.svg";
                  ...
                  <table className="table table-xs my-5 md:w-[125%] sm:w-[130%] w-[150%] lg:w-full table_w">
                    <thead>
                      <tr>
                        ...
                        <th className="craete_tbl_row text-[#A8A8A8]">Cast</th>
                        <th className="craete_tbl_row text-[#A8A8A8]">
                          Email Id
                        </th>
                        <th className="craete_tbl_row text-[#A8A8A8]">
                    ...
                    <tbody className="border-none">
                      <tr>
                        ...
                        <td className="craete_tbl_row">450</td>
                        <td className="craete_tbl_row">OBC</td>
                      ...
                      <tr>
                        ...
                        <td className="craete_tbl_row">321</td>
                        <td className="craete_tbl_row">Open</td>{" "}
                      ...
                      <tr>
                        <td className="py-3">
                          <div className="flex gap-3 items-center">
                            <div>
                              <Image src={s10} className="superAD_sImg" />
                            </div>
                            <div>
                              <p className="craete_tbl_row">Narendra Kumar</p>
                              <p className="text-[#A8A8A8] legend font-[400] 2xl:text-[13px] 2xl:leading-[20px] xl:text-[11px] xl:leading-[18px] lg:text-[10px] lg:leading-[16px] sm:text-[10px] sm:leading-[12px] text-[9px] leading-[12px]">
                                Under Graduate
                              </p>
                            </div>
                        ...
                        <td className="craete_tbl_row">321</td>
                        <td className="craete_tbl_row">Open</td>
                        <td className="craete_tbl_row">narendrakumar@gmail.com</td>
                        <td className="craete_tbl_row">955 445 5588</td>
