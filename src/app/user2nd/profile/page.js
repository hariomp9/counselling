        ...
        <div className="flex">
          ...
          <div className="w-11/12">
            ...
            <div className="w-full 2xl:p-10 xl:p-6 lg:p-4">
              <div className="2xl:w-[1172px] xl:w-[65%] w-[80%] 2xl:h-[207px] border-[1px]  xl:h-[170px] rounded-[10px] 2xl:p-4 xl:p-3 lg:p-2">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <Image
                      src={userImg}
                      className="2xl:w-[74px] 2xl:h-[74px] xl:w-[45px] xl:h-[45px] w-[45px] h-[45px]"
                    />
              ...
              <div className="2xl:w-[1172px] xl:w-[65%] w-[80%] 2xl:h-[451px] border-[1px] rounded-[10px] 2xl:my-10 xl:my-7 lg:my-5  ">
