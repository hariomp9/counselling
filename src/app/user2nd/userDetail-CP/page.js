        ...
        <div className="flex w-full">
          ...
          <div className="w-full">
            ...
            <div className="w-[1725px] mx-auto ">
              <div className="w-full 2xl:h-[127px] px-[35px] bg-[#F5F6FF] rounded-[10px] flex items-center 2xl:mt-[30px]">
                <div>
                  <h1 className="inter font-[700] text-[30px]">
                    Complete your profile
                  </h1>
                  <p className="inter font-[400] 2xl:text-[14px] 2xl:leading-[24px]">
                    Start completing your profile to get better result and
                    analysis
                  </p>
                </div>
              </div>
              <div className="flex 2xl:mt-[30px] ">
